...
{
    internal class WorldFactory // only in Engine Project
    {
        internal World CreateWorld() //internal function only in Engine Project
        {
            ...
            newWorld.AddLocation(-2, -1, "Farmer's Field",
                "There are rows of corn growing here, with giant rats hiding betwen them.",
            ...
            return newWorld; //instatiutne new world object
        }
    }
}
